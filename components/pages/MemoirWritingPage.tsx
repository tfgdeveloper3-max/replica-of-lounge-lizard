...
// --- Data ---
const categories = [
    { icon: Heart, title: "Personal & Overcoming", desc: "Stories of resilience, trauma, healing, and the monumental moments that redefine a life." },
    { icon: Users, title: "Family & Legacy", desc: "Preserving generational history, ancestral journeys, and the values that bind a family together." },
    { icon: TreePine, title: "Travel & Adventure", desc: "Chronicles of exploration, cultural immersion, and the transformative power of seeing the world." },
    { icon: BookOpen, title: "Public Figure & Business", desc: "The untold struggles and behind-the-scenes truths of industry leaders and public personalities." },
];

const processSteps = [
    { step: "01", title: "Empathetic Interviews", desc: "Through recorded conversations, we gently extract the emotions, details, and reflections of your journey.", icon: Mic },
    { step: "02", title: "Thematic Structuring", desc: "We identify the core message and narrative arc, turning scattered memories into a cohesive story.", icon: BookOpen },
    { step: "03", title: "Emotional Drafting", desc: "Our writers craft the manuscript focusing on 'show, don't tell', capturing your authentic voice and emotional truth.", icon: PenTool },
    { step: "04", title: "Review & Privacy Check", desc: "You approve every chapter. We ensure sensitive details are handled with absolute respect and NDA protection.", icon: ShieldCheck },
];

const faqs = [
    { q: "What is the difference between a memoir and an autobiography?", a: "An autobiography tells the entire story of your life chronologically from birth to present. A memoir focuses on a specific theme, period, or aspect of your life, exploring the emotional truth and lessons learned rather than just the facts." },
    { q: "Do I need to be famous to write a memoir?", a: "Not at all. Some of the most successful memoirs are by everyday people who have experienced extraordinary circumstances, overcome immense challenges, or have a unique perspective. It’s the emotional resonance that matters, not the fame." },
    { q: "How do you handle sensitive or traumatic memories?", a: "With the utmost care and respect. Our writers are trained to handle sensitive topics empathetically. You have full control over what is included, and we ensure a safe space during the interview process. Strict NDAs are always in place." },
    { q: "What if I can't remember all the details?", a: "That's completely normal. Our interview process is designed to jog your memory through sensory cues and associative questions. We help fill in the narrative gaps while maintaining the absolute truth of your experience." },
    { q: "Who owns the rights to my memoir?", a: "You do. 100%. It is your life story. We operate under strict NDAs, and upon completion, all intellectual property and copyright are transferred to you. We take zero royalties and zero credit." },
];
...
export default function MemoirWritingPage() {
    ...
    return (
        <main className="w-full overflow-hidden" style={{ fontFamily: "'Raleway', Arial, sans-serif" }}>
            ...
            {/* ════════════════════════════════════════════
                SECTION 1: CINEMATIC MEMOIR HERO
            ════════════════════════════════════════════ */}
            <section className="relative w-full min-h-screen flex items-center justify-center bg-[#05070f] overflow-hidden pt-28 pb-12">
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
                    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }} className="flex items-center justify-center gap-3 mb-6">
                        ...
                        <span className="text-[#e8391d] font-black uppercase tracking-[0.28em] text-[11px]">Memoir Writing Services</span>
                    </motion.div>
                    ...
                    <motion.h1 variants={maskReveal} initial="hidden" animate="visible" className="font-black text-white uppercase leading-[0.95] mb-8" style={{ fontSize: "clamp(3rem, 8vw, 7rem)" }}>
                        YOUR LIFE, YOUR <br /><span className="text-[#e8391d]">LEGACY.</span>
                    </motion.h1>
                    ...
                    <motion.p variants={fadeUp} initial="hidden" animate="visible" className="text-white/60 leading-[1.85] max-w-2xl mx-auto mb-10" style={{ fontSize: "clamp(0.9rem, 1.1vw, 1.05rem)" }}>
                        Turn your most profound life experiences into a captivating memoir that inspires generations. We honor your truth and craft it into a timeless narrative.
                    </motion.p>
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <motion.div variants={staggerContainer} initial="hidden" animate={overviewInView ? "visible" : "hidden"} className="flex flex-col">
                        <motion.div variants={fadeUp} className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[#e8391d] font-black uppercase tracking-[0.28em] text-[11px]">Emotional Storytelling</span>
                        </motion.div>
                        ...
                        <motion.h2 variants={fadeUp} className="font-black text-black uppercase leading-[1.05] mb-6" style={{ fontSize: "clamp(2rem, 3.8vw, 3.2rem)" }}>
                            PRESERVING TRUTH, <span className="text-[#e8391d]">ONE CHAPTER AT A TIME.</span>
                        </motion.h2>

                        <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-5" style={{ fontSize: "0.95rem" }}>
                            A memoir is more than just a record of events—it is the emotional truth of your life. It’s about how a specific experience shaped you, broke you, or made you who you are today.
                        </motion.p>
                        <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-8" style={{ fontSize: "0.95rem" }}>
                            Our memoir writers are empathetic listeners first. Through deep interviews, we extract the nuances of your memory—the sights, the sounds, the feelings—and weave them into a narrative that reads like a compelling novel, but remains authentically yours.
                        </motion.p>

                        <motion.div variants={staggerContainer} className="flex flex-col gap-4">
                            {["Empathetic Interview-Based Extraction", "Focus on Emotional Truth, Not Just Facts", "Strict NDA for Sensitive Life Stories", "100% Copyright & Legacy Ownership"].map((item) => (
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.9 }} animate={overviewInView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.8, ease: smoothEase }} className="relative hidden lg:block">
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-black/20" style={{ aspectRatio: "4/5" }}>
                            <Image src="/images/memoir-writing-overview.webp" alt="Memoir Writing Service" fill className="object-cover" />
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10">
                    <div className="text-center mb-16 overflow-hidden">
                        <motion.div initial={{ y: "100%" }} whileInView={{ y: 0 }} viewport={{ once: true }} className="flex items-center justify-center gap-3 mb-4">
                            <Clock size={16} className="text-[#e8391d]" />
                            <span className="text-[#e8391d] font-black uppercase tracking-[0.28em] text-[11px]">Types of Memoirs</span>
                        </motion.div>
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-white uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                            STORIES WE <span className="text-[#e8391d]">PRESERVE</span>
                        </motion.h2>
                    </div>
            ...
            {/* ════════════════════════════════════════════
                SECTION 4: THE MEMOIR WRITING PROCESS
            ════════════════════════════════════════════ */}
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16">
                    <div className="text-center mb-20">
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-black uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                            OUR MEMOIR <span className="text-[#e8391d]">PROCESS</span>
                        </motion.h2>
                    </div>
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
                        <div className="rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: "1/1" }}>
                            <Image src="/images/memoir-team.webp" alt="Memoir Interviewers" fill className="object-cover" />
                    ...
                    <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                        ...
                        <motion.h2 variants={fadeUp} className="font-black text-white uppercase leading-[1.05] mb-10" style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
                            WE LISTEN. WE FEEL. <br /><span className="text-[#e8391d]">WE WRITE.</span>
                        </motion.h2>

                        <motion.div variants={staggerContainer} className="flex flex-col gap-5">
                            {[
                                "Empathetic Listeners — We handle your memories with deep respect.",
                                "Emotional Truth — We capture how it felt, not just what happened.",
                                "Strict Privacy & NDA — Your sensitive stories are safe with us.",
                                "Narrative Arc Mastery — Turning life events into page-turning stories.",
                                "Legacy Focused — A book that honors your journey and family."
                            ].map((item) => (
                ...
                <div className="max-w-[900px] mx-auto px-8 relative z-10">
                    <div className="text-center mb-16">
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-black uppercase leading-none" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
                            MEMOIR WRITING <span className="text-[#e8391d]">FAQS</span>
                        </motion.h2>
                    </div>
            ...
            <section className="relative w-full bg-[#e8391d] py-28 overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center px-8 relative z-10">
                    <h2 className="font-black text-white uppercase leading-tight mb-6" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                        DON'T LET YOUR STORY FADE.
                    </h2>
                    <p className="text-white/80 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                        Your experiences deserve more than just memories. Let’s write them down and create a legacy that lasts forever.
                    </p>
                    <div className="flex flex-wrap justify-center gap-5">
                        <motion.a href="/contact" whileHover={{ backgroundColor: "#fff", color: "#e8391d", gap: "14px", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }} whileTap={{ scale: 0.95 }} className="inline-flex items-center gap-3 bg-black text-white font-black uppercase tracking-widest px-10 py-5 rounded-xl text-[14px] cursor-pointer transition-all duration-300">
                            Start Your Memoir <ArrowRight size={18} />
                        </motion.a>
