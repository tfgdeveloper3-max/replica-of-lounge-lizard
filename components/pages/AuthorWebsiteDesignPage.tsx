...
const authorFeatures = [
    { icon: BookOpen, title: "Book Showcase Pages", desc: "Dedicated pages for every book with 3D cover mockups, synopses, editorial reviews, and universal buy links to all retailers." },
    { icon: Mail, title: "Mailing List Capture", desc: "Strategically placed sign-up forms synced with Mailchimp or ConvertKit. Turn casual visitors into lifelong subscribers." },
    { icon: Newspaper, title: "Press & Media Kit", desc: "A professional resource for journalists, podcasters, and event organizers — downloadable headshots, bios, and one-sheets." },
    { icon: CalendarDays, title: "Events & Appearances", desc: "A dynamic calendar for book signings, readings, and interviews. Keep your audience engaged with your latest schedule." },
];

const readerFunnel = [
    { icon: Search, title: "Attract", desc: "SEO-optimized content and blog architecture that drives organic traffic from Google straight to your books." },
    { icon: MousePointerClick, title: "Capture", desc: "Irresistible lead magnets — free chapters, short stories, or checklists — that convert visitors into email subscribers." },
    { icon: ShoppingCart, title: "Convert", desc: "Strategic buy buttons, direct sales integration, and optimized book pages that turn interest into purchases." },
    { icon: Users, title: "Retain", desc: "Community features, newsletter integration, and reader engagement tools that build a loyal fanbase for life." },
];

const processSteps = [
    { step: "01", title: "Strategy & Sitemap", desc: "We map your website's architecture, user flows, and conversion goals before a single pixel is designed.", icon: Layout },
    { step: "02", title: "Custom Design", desc: "Our designers create a visual identity that matches your author brand — custom, not from a generic template.", icon: PenTool },
    { step: "03", title: "Development & Integration", desc: "We build a blazing-fast site integrated with your mailing list, book retailers, and analytics platforms.", icon: Server },
    { step: "04", title: "Launch & SEO", desc: "Your site goes live fully optimized for search engines, speed-tested, and secured with SSL and backups.", icon: Globe },
];

const faqs = [
    { q: "What platform do you build on?", a: "We build on modern, author-friendly platforms — primarily WordPress and Webflow. WordPress offers maximum flexibility and plugin integration. Webflow delivers stunning design with effortless maintenance. We recommend based on your specific needs." },
    { q: "Can I sell books directly from my website?", a: "Absolutely. We integrate direct sales via Shopify, WooCommerce, or Payhip — allowing you to sell eBooks, audiobooks, and print books while keeping up to 90% of royalties and owning the customer relationship." },
    { q: "Do I own my website and domain?", a: "Yes, 100%. You own the domain, the design, the content, and all the code. We set everything up in your own hosting accounts. You are never locked into our platform." },
    { q: "Will my website work on mobile devices?", a: "Every site we build is mobile-first. Over 60% of author website traffic comes from phones. We design for mobile first, then enhance for desktop — ensuring a flawless experience on every screen." },
    { q: "How do I update my website when I publish a new book?", a: "We build your site on an easy-to-use CMS. Adding a new book, blog post, or event is as simple as filling out a form. We also provide training videos and ongoing support if you'd prefer we handle updates." },
    { q: "Do you include SEO and speed optimization?", a: "Yes. Every site launches with foundational SEO — meta tags, structured data, XML sitemaps, and keyword-optimized content. We also optimize for Core Web Vitals, ensuring your site loads fast and ranks well." },
];
...
export default function AuthorWebsiteDesignPage() {
    ...
    return (
        <main className="w-full overflow-hidden" style={{ fontFamily: "'Raleway', Arial, sans-serif" }}>
            ...
            <section className="relative w-full h-screen flex items-center justify-center bg-[#05070f] overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
                    ...
                    <motion.h1 variants={maskReveal} initial="hidden" animate="visible" className="font-black text-white uppercase leading-[0.95] mb-8" style={{ fontSize: "clamp(3rem, 8vw, 7rem)" }}>
                        YOUR DIGITAL <br /><span className="text-[#e8391d]">HEADQUARTERS.</span>
                    </motion.h1>
                    ...
                    <motion.p variants={fadeUp} initial="hidden" animate="visible" className="text-white/60 leading-[1.85] max-w-2xl mx-auto mb-10" style={{ fontSize: "clamp(0.9rem, 1.1vw, 1.05rem)" }}>
                        Social media platforms change their algorithms. Retailers control your product pages. Your website is the only space you truly own — designed to capture readers, sell books, and build your brand forever.
                    </motion.p>
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <motion.div variants={staggerContainer} initial="hidden" animate={overviewInView ? "visible" : "hidden"} className="flex flex-col">
                        ...
                        <motion.h2 variants={fadeUp} className="font-black text-black uppercase leading-[1.05] mb-6" style={{ fontSize: "clamp(2rem, 3.8vw, 3.2rem)" }}>
                            MORE THAN A WEBSITE. <br /><span className="text-[#e8391d]">A READER MAGNET.</span>
                        </motion.h2>

                        <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-5" style={{ fontSize: "0.95rem" }}>
                            Most author websites are digital brochures — a bio, a photo, and a couple of buy links. That's not a strategy. A professional author website is a conversion machine designed to capture visitors, grow your email list, and sell books on autopilot.
                        </motion.p>
                        <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-8" style={{ fontSize: "0.95rem" }}>
                            We design and develop custom author websites that reflect your brand, showcase your books beautifully, and funnel casual browsers into dedicated readers. Every element is strategically placed with one goal: grow your audience.
                        </motion.p>

                        <motion.div variants={staggerContainer} className="flex flex-col gap-4">
                            {["Custom Design — No Templates", "Mobile-First & Lightning Fast", "Mailing List & E-Commerce Ready", "SEO Optimized for Discoverability"].map((item) => (
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.9 }} animate={overviewInView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.8, ease: smoothEase }} className="relative hidden lg:block">
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-black/20" style={{ aspectRatio: "4/5" }}>
                            <Image src="/images/services-website-design.webp" alt="Author Website Design Service" fill className="object-cover" />
            ...
            {/* ════════════════════════════════════════════
                SECTION 3: ESSENTIAL AUTHOR FEATURES (UNIQUE)
            ════════════════════════════════════════════ */}
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10">
                    <div className="text-center mb-16 overflow-hidden">
                        ...
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-white uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                            ESSENTIAL AUTHOR <span className="text-[#e8391d]">FEATURES</span>
                        </motion.h2>
                        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="text-white/40 mt-4 max-w-xl mx-auto text-[15px] leading-relaxed">
                            Generic web designers build generic sites. We build author platforms with the tools you actually need to grow your career.
                        </motion.p>
                    </div>
            ...
            {/* ════════════════════════════════════════════
                SECTION 4: THE READER FUNNEL (UNIQUE)
            ════════════════════════════════════════════ */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                            ...
                            <motion.h2 variants={fadeUp} className="font-black text-black uppercase leading-[1.05] mb-6" style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
                                THE READER <br /><span className="text-[#e8391d]">FUNNEL</span>
                            </motion.h2>

                            <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-10" style={{ fontSize: "0.95rem" }}>
                                Traffic without conversion is wasted potential. Your website is engineered to guide every visitor through a strategic journey — from stranger to superfan.
                            </motion.p>
                        ...
                        <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative hidden lg:block">
                            <div className="rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: "1/1" }}>
                                <Image src="/images/about-us-bg.webp" alt="Website Conversion Strategy" fill className="object-cover" />
                            ...
                            <div className="absolute -right-6 top-12 bg-[#e8391d] rounded-2xl px-6 py-4 shadow-2xl shadow-[#e8391d]/30">
                                <p className="font-black text-white text-2xl">73%</p>
                                <p className="text-white/70 text-[11px] font-bold uppercase tracking-wider">Of readers visit author sites</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="relative w-full bg-[#faf9f7] py-32 overflow-hidden">
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
                        <div className="rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: "1/1" }}>
                            <Image src="/images/about-us-bg.webp" alt="Author Website Team" fill className="object-cover" />
                            <div className="absolute inset-0 bg-[#e8391d]/20 mix-blend-multiply" />
                        </div>
                        ...
                        {/* Floating Stat */}
                        <div className="absolute -right-6 top-12 bg-[#e8391d] rounded-2xl px-6 py-4 shadow-2xl shadow-[#e8391d]/30">
                            <p className="font-black text-white text-2xl">99/100</p>
                            <p className="text-white/70 text-[11px] font-bold uppercase tracking-wider">Google PageSpeed score</p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                        ...
                        <motion.h2 variants={fadeUp} className="font-black text-black uppercase leading-[1.05] mb-10" style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
                            WEBSITES BUILT FOR <br /><span className="text-[#e8391d]">AUTHORS, NOT JUST ANYONE.</span>
                        </motion.h2>

                        <motion.div variants={staggerContainer} className="flex flex-col gap-5">
                            {[
                                "Author Industry Experts — We understand book marketing, launch funnels, and reader psychology.",
                                "Blazing Fast Performance — 99+ PageSpeed scores. No bloated code, no slow loading.",
                                "You Own Everything — Domain, hosting, design, content. Full access, zero lock-in.",
                                "Built-In Marketing Tools — Email capture, direct sales, and SEO from day one.",
                                "Easy Self-Management — Add books, blog posts, and events without touching code."
                            ].map((item) => (
                ...
                <div className="max-w-[900px] mx-auto px-8 relative z-10">
                    <div className="text-center mb-16">
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-white uppercase leading-none" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
                            WEBSITE DESIGN <span className="text-[#e8391d]">FAQS</span>
                        </motion.h2>
                    </div>
            ...
            <section className="relative w-full bg-[#e8391d] py-28 overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center px-8 relative z-10">
                    ...
                    <p className="text-white/80 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                        Your readers are searching for you. Give them a home base that captures their attention, their email, and their loyalty.
                    </p>
